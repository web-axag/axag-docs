...
**AXAG (Agent Context Annotation Guidelines)** is an annotation standard that makes interface semantics explicit and machine-readable for AI agents. It defines a **semantic interaction contract** — a formal declaration of what each interface element means, what it does, what it requires, and what it produces.
