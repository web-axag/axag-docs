...
## Example
```html
<section axag-scope="tenant" axag-tenant-boundary="strict" axag-required-roles='["admin"]'>
  <!-- Both buttons inherit scope="tenant", tenant-boundary="strict", required-roles=["admin"] -->
